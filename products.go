...
func (c *Client) GetProducts(ctx context.Context, opts types.GetProductsOpts) (*types.GetProductsResponse, error) {
	...
	_, err := query.Values(opts)
	if err != nil {
		return nil, err
	}
	err = c.call(ctx, APIPathProducts, http.MethodGet, nil, nil, &result)
	if err != nil {
		return nil, err
	}
...
func (c *Client) PostProducts(ctx context.Context, params types.PostProductsOpts) (*types.PostProductsResponse, error) {
